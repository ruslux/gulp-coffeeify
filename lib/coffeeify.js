(function() {
  var PluginError, RED, RESET, _, aliasMap, browserify, coffee, fs, glob, gutil, path, replaceExtension, through2, traceError, transformCache;
    ...
    return through2.obj(function(file, enc, cb) {
      ...
      b.transform(function(file) {
        return through2.obj(function(data, enc, cb) {
          var e, extname, filePath, i, len, mtime, raw, ref, transform;
          raw = data;
          data = String(data);
          if (data === srcContents) {
            file = srcFile;
