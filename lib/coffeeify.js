(function() {
  var File, PluginError, RED, RESET, Readable, aliasMap, arrayStream, browserify, coffee, cson, fs, glob, gutil, path, replaceExtension, through2, traceError, transformCache, _;
  ...
  module.exports = function(opts) {
    ...
    if (!(_.find(opts.transforms, function(xform) {
      return xform.ext === ".coffee";
    }))) {
    ...
    return through2.obj(function(file, enc, cb) {
      ...
      b.transform(function(file) {
        return through2.obj(function(data, enc, cb) {
          var e, extname, filePath, mtime, raw, xform, _i, _len, _ref;
          raw = data;
          data = String(data);
          if (data === srcContents) {
            file = srcFile;
